      ...
      <div style={{ flex: 1, position: 'relative', display: 'none' }} className="auth-visual-container">
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '3rem', fontWeight: 900, lineHeight: 1.1, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
            Enter the <br/>Cinematic Universe.
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', lineHeight: 1.6 }}>
            Experience premium entertainment with MovieDex.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleEmailSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                <div className="auth-elem">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '0.5rem' }}>
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Password</label>
                    <Link to="/forgot-password" style={{ color: 'var(--brand-secondary)', fontSize: '0.8rem', fontWeight: 600, textDecoration: 'none' }}>Forgot Password?</Link>
                  </div>
                  <input 
              ...
              <div className="auth-elem" style={{ marginTop: '2.5rem', textAlign: 'center', fontSize: '0.9rem', color: 'rgba(255,255,255,0.5)' }}>
                Don't have an account? <Link to="/register" style={{ color: '#fff', fontWeight: 600, textDecoration: 'none', marginLeft: '0.25rem', borderBottom: '1px solid #fff' }}>Create one</Link>
              </div>
